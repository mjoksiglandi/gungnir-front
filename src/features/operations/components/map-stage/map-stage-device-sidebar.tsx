...
function deviceDotClassName(status: Asset["status"]) {
  if (status === "nominal") return styles.deviceDotNominal;
  if (status === "degraded") return styles.deviceDotDegraded;
  return styles.deviceDotLost;
}
