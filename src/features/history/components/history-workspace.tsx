...
} from "@/features/history/utils/history-helpers";
  ...
  return (
    <section className={styles.workspace}>
      <header className={styles.header}>
        <div>
          <p className={styles.eyebrow}>Replay / Historicos</p>
          <h1 className={styles.title}>Rutas guardadas por fecha</h1>
          <p className={styles.copy}>
            Filtra por tipo de dispositivo, rango de fechas y busqueda por nombre o callsign para reconstruir la ruta seguida.
          </p>
        </div>
          ...
          <div className={styles.resultList}>
            {filteredRecords.length === 0 ? (
              <div className={styles.emptyState}>
                ...
                <p>Ajusta fecha, tipo o busqueda para recuperar recorridos guardados.</p>
              </div>
          ...
          <section className={styles.detailPanel}>
            {selectedRecord ? (
                  ...
                  {selectedRecord.filteredPoints.map((point) => (
                    <article key={point.id} className={styles.timelineRow}>
                      ...
                      <div className={styles.timelineBody}>
                        ...
                        <span>
                          {typeof point.position.headingDeg === "number" ? `Rumbo ${Math.round(point.position.headingDeg)} deg` : "Sin rumbo"}
                          {" - "}
              ...
              <div className={styles.emptyState}>
                ...
                <p>Cuando exista historial para el filtro actual, la ruta aparecera aqui junto a su secuencia temporal.</p>
              </div>
            )}
          </section>
        </div>
