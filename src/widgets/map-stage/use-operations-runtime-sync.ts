...
function readFirstMeaningfulText(
...
export function resolveRuntimeAssetIdentity(
  ...
  const preferredCallsign = readFirstMeaningfulText(sources, [
    "callsign",
    "assetCallsign",
    "asset_callsign",
    "deviceCallsign",
    ...
    "label",
    "title",
  ], (value) => !isAutoGeneratedDisplayName(value));
  ...
  if (deviceIdentifier && isSyntheticAssetIdentifier(asset.callsign)) {
    return {
      callsign: preferredCallsign ?? device?.externalId ?? deviceIdentifier,
