...
import { buildOperationsHref, getAlertDetailHref } from "@/lib/navigation/entity-routes";
import { operationalDataGateway } from "@/services/data";
import { formatPercent, formatSpeedKph } from "@/utils/format";
    ...
    <div className={styles.page}>
      ...
      <section className={styles.grid}>
        ...
        <article className={styles.card}>
          ...
          <p className={styles.value}>{asset.position.headingDeg ?? 0} deg</p>
        </article>
        <article className={styles.card}>
